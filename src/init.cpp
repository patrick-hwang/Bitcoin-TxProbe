...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-txprobelogfile=<filename>", "Specify output log file for txprobe events (default: txprobe.log)", ArgsManager::ALLOW_ANY, OptionsCategory::CONNECTION);
